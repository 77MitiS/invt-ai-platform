...
/**
 * Sample plugin demonstrating the Invt Plugin SDK.
 * <p>
 * Registers a simple "hello_world" tool that agents can call.
 *
 * @author Invt Team
 */
public class HelloPlugin implements InvtPlugin {
    ...
    public String hello_world(
        ...
        return "Hello, " + name + "! This message comes from the Invt Hello World plugin.";
    }
}
