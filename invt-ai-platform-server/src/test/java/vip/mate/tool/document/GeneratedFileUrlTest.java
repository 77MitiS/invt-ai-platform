 ...
 * when {@code invt.server.public-base-url} is set the URL is absolute, and
...
class GeneratedFileUrlTest {
    ...
    void absoluteWhenConfigured() {
        ReflectionTestUtils.setField(cache, "publicBaseUrl", "https://invt-ai-platform.gacgroup.com/");
        String url = cache.downloadUrl("abc-123");
        assertEquals("https://invt-ai-platform.gacgroup.com/api/v1/files/generated/abc-123", url);
    }
    ...
    void patternMatchesAbsolute() {
        Matcher m = GeneratedFileCache.GENERATED_URL_PATTERN
                .matcher("see https://invt-ai-platform.gacgroup.com/api/v1/files/generated/xy-9 now");
        assertTrue(m.find());
        assertEquals("xy-9", m.group(1), "id group must exclude the scheme://host prefix");
        assertEquals("https://invt-ai-platform.gacgroup.com/api/v1/files/generated/xy-9", m.group(0),
    ...
    void scrubAbsoluteFakeLeavesNoHost() {
        String text = "下载: https://invt-ai-platform.gacgroup.com/api/v1/files/generated/"
                + "00000000-0000-0000-0000-000000000000";
        String scrubbed = cache.scrubMissingReferences(text);
        assertFalse(scrubbed.contains("/api/v1/files/generated/"));
        assertFalse(scrubbed.contains("invt-ai-platform.gacgroup.com"),
    ...
    void scrubAbsoluteLivePassesThrough() {
        ...
        String text = "下载: https://invt-ai-platform.gacgroup.com/api/v1/files/generated/" + id;
