...
class SkillSecretServiceTest {
    ...
    void rejectsBadKeys() {
        assertThrows(InvtException.class, () -> service.put(1L, "with-dash", "v"));
        assertThrows(InvtException.class, () -> service.put(1L, "1leading-digit", "v"));
        assertThrows(InvtException.class, () -> service.put(1L, "", "v"));
        assertThrows(InvtException.class, () -> service.put(1L, null, "v"));
        assertThrows(InvtException.class, () -> service.put(null, "FOO", "v"));
        verifyNoInteractions(mapper);
    }
