...
class SkillControllerVirtualGuardTest {
    ...
    void updateRejectsVirtualAcpId() {
        ...
        assertThrows(InvtException.class,
    ...
    void mutationFamilyAllGuarded() {
        long virtualId = McpSkillBridge.VIRTUAL_ID_BASE + 42L;
        assertThrows(InvtException.class, () -> controller.delete(virtualId, null));
        assertThrows(InvtException.class, () -> controller.rescan(virtualId, null));
    }
    ...
    void realIdNotGuarded() {
        ...
        // A virtual-id call would have thrown InvtException before
        // reaching the service.
        try {
            real.update(snowflakeId, new SkillEntity(), null);
        } catch (InvtException e) {
            // The guard message contains "MCP/ACP"; any other InvtException
