...
public class GeminiNativeClient {
    ...
    public Flux<StreamEvent> streamEvents(GeminiCall call) {
        ...
        return webClient.post()
                ...
                .onStatus(status -> status.is4xxClientError() || status.is5xxServerError(),
                        response -> response.bodyToMono(String.class)
                                ...
                                .map(errorBody -> {
                                    ...
                                    return new InvtException("err.llm.gemini_error",
                ...
                .onErrorMap(e -> e instanceof InvtException ? e
                        : new InvtException("err.llm.gemini_stream_failed",
    ...
    public JsonNode generate(GeminiCall call) {
        ...
        try {
            ...
            throw new InvtException("err.llm.gemini_error", "Gemini 响应解析失败: " + e.getMessage());
        }
    }
    ...
    private List<StreamEvent> parseChunk(String json) {
        ...
        try {
            ...
            if (error != null && !error.isNull()) {
                throw new InvtException("err.llm.gemini_error",
