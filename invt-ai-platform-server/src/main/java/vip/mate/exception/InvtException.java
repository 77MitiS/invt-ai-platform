 ...
 */
@Getter
public class InvtException extends RuntimeException {

    private final int code;
    /** i18n message key (optional). When set, GlobalExceptionHandler uses this to look up translated message. */
    private final String msgKey;

    public InvtException(String message) {
        super(message);
        this.code = 500;
        this.msgKey = null;
    }

    public InvtException(int code, String message) {
        super(message);
        this.code = code;
        this.msgKey = null;
    }

    public InvtException(ResultCode resultCode) {
     ...
     */
    public InvtException(String msgKey, String message) {
        super(message);
        this.code = 500;
        this.msgKey = msgKey;
    }
     ...
     */
    public InvtException(String msgKey, int code, String message) {
        super(message);
        this.code = code;
        this.msgKey = msgKey;
    }
