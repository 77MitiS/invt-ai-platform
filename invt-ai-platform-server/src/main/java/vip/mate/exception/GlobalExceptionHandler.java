 ...
 * <p>
 * InvtException messages are translated through I18nService when the
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(InvtException.class)
    public ResponseEntity<R<Void>> handleInvtException(InvtException e) {
     ...
     */
    private String translateExceptionMsg(InvtException e) {
