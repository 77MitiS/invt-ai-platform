...
import static vip.mate.agent.graph.state.InvtStateKeys.GOAL_EVALUATED_THIS_RUN;
import static vip.mate.agent.graph.state.InvtStateKeys.GOAL_FOLLOWUP_INJECTED;
