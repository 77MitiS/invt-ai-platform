 ...
 *       success metrics.</li>
 *   <li>If every provider fails, throw a {@link InvtException} carrying
...
public class ImageVisionService {
     ...
     *
     * @throws InvtException with key {@code err.wiki.vision.disabled} when the feature flag is off
     * @throws InvtException with key {@code err.wiki.vision.no_provider} when no provider is available
     * @throws InvtException with key {@code err.wiki.vision.all_failed} when every provider failed
     */
    public VisionResult caption(VisionRequest request) {
        ...
        if (!featureFlagService.isEnabled(FEATURE_FLAG)) {
            throw new InvtException("err.wiki.vision.disabled",
        ...
        if (available.isEmpty()) {
            throw new InvtException("err.wiki.vision.no_provider",
        ...
        if (winner == null) {
            ...
            throw new InvtException("err.wiki.vision.all_failed",
