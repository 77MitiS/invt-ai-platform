...
@Slf4j
@Component
public class InvtDocTool {

    private static final Pattern VALID_PATH = Pattern.compile("^(zh|en)/[a-z0-9_-]+\\.md$");
    private static final String DOCS_BASE = "docs/";

    @Tool(description = """
        Read Invt project documentation.
        Use this tool to look up information about Invt's features, configuration, and usage.
    ...
    private String listDocs() {
        try {
            ...
            sb.append("\nUse readInvtDoc(action=\"read\", path=\"zh/config.md\") to read a specific doc.");
            return sb.toString();
