...
public class DelegateAgentTool {
     ...
     *
     * <p>Configurable via {@code invt.delegation.parallel-timeout-seconds};
     ...
     */
    @Value("${invt.delegation.parallel-timeout-seconds:300}")
     ...
     * {@code invt.delegation.child-denied-tools}.
     */
     ...
     * {@code invt.delegation.child-denied-tools} as a comma-separated
     ...
     */
    @Value("${invt.delegation.child-denied-tools:}")
