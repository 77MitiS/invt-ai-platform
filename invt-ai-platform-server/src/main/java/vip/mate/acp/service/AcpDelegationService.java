 ...
 * </ol>
 *
 * <p>The streaming surface (chunk-by-chunk relay back through Invt's
...
public class AcpDelegationService {
     ...
     * {@link InvtException} for configuration / runtime errors so
    ...
    public String prompt(String endpointName, String userPrompt, String cwdHint) {
        ...
        try {
            ...
            throw new InvtException("err.acp.spawn_failed",
        ...
        try (AcpStdioClient autoClose = client) {
            ...
            if (initResp == null || initResp.path("protocolVersion").asInt(-1)
                ...
                throw new InvtException("err.acp.protocol_mismatch",
            ...
            if (sessionId == null || sessionId.isBlank()) {
                throw new InvtException("err.acp.session_failed",
            ...
            if (authHint != null) {
                throw new InvtException("err.acp.auth_failed", authHint);
            }
            throw new InvtException("err.acp.delegation_failed",
