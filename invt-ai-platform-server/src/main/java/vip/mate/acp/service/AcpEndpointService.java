...
public class AcpEndpointService {
    ...
    public AcpEndpointEntity get(Long id) {
        ...
        if (ep == null) throw new InvtException("err.acp.endpoint_not_found",
    ...
    public AcpEndpointEntity create(AcpEndpointEntity input) {
        if (input.getName() == null || input.getName().isBlank()) {
            throw new InvtException("err.acp.name_required", "ACP endpoint name is required");
        }
        if (input.getCommand() == null || input.getCommand().isBlank()) {
            throw new InvtException("err.acp.command_required", "ACP endpoint command is required");
        }
        if (findByName(input.getName()) != null) {
            throw new InvtException("err.acp.name_exists",
    ...
    public AcpEndpointEntity update(Long id, AcpEndpointEntity patch) {
        ...
        if (Boolean.TRUE.equals(existing.getBuiltin())
            ...
            throw new InvtException("err.acp.builtin_command_locked",
    ...
    public void delete(Long id) {
        AcpEndpointEntity existing = get(id);
        if (Boolean.TRUE.equals(existing.getBuiltin())) {
            throw new InvtException("err.acp.builtin_readonly",
