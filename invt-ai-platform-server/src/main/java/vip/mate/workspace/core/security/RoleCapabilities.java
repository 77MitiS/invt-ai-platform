...
public final class RoleCapabilities {
    ...
    static {
        ...
        // Super admin inherits everything from admin, plus system-level capabilities.
        Set<String> superAdmin = new LinkedHashSet<>(admin);
        superAdmin.add(Capability.MANAGE_SYSTEM);
        ...
        ROLE_TO_CAPS = Map.of(
                ...
                ROLE_SUPER_ADMIN, Collections.unmodifiableSet(superAdmin)
        );
    }
