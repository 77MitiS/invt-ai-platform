...
This page is source-aligned with the Spring MVC controllers under `invt-ai-platform-server/src/main/java`. The route inventory below was rebuilt from controller annotations; when it conflicts with an older feature page, this page and the source code are the contract.
