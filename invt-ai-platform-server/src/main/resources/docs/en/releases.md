...
Release notes for every Invt version. The latest documentation always lives in `docs/en/` as the single source of truth — these notes are about what *changed* in each version.
...
- [Introduction](./intro) — why Invt exists
