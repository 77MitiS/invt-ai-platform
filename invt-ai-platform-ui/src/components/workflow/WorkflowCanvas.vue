...
onMounted(() => {
  window.addEventListener('invt:workflow-step-select', handleDomStepSelect as EventListener)
...
onBeforeUnmount(() => {
  window.removeEventListener('invt:workflow-step-select', handleDomStepSelect as EventListener)
  document.removeEventListener('keydown', handleEsc)
  document.body.style.overflow = ''
