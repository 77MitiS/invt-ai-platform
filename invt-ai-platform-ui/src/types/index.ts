...
export const CHANNEL_FIELD_DEFS: Record<string, ChannelFieldDef[]> = {
  ...
  feishu: [
    ...
    { key: 'media_download_enabled', label: '媒体下载', placeholder: '', type: 'switch', defaultValue: false, tooltip: '下载消息中的图片和文件到本地（保存至 ~/.invt-ai-platform/media/feishu/）' },
  ],
  telegram: [
  ...
  webchat: [
    ...
    { key: 'title', label: '标题', placeholder: 'INVT AI Platform', type: 'text', defaultValue: 'INVT AI Platform', tooltip: '聊天面板顶部显示的标题' },
 ...
 * invt. {@code total/size/current/pages} arrive as JSON strings because the
