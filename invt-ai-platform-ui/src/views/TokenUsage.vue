          ...
          <div v-if="data.byModel && data.byModel.length > 0" class="table-section">
            ...
            <div class="table-wrap">
              <table class="data-table">
                <thead>
                  <tr>
                    <th style="width:20%">{{ t('tokenUsage.provider') }}</th>
                                        <th style="width:28%">{{ t('tokenUsage.model') }}</th>
                                        <th style="width:22%" class="num-col">{{ t('tokenUsage.promptTokens') }}</th>
                                        <th style="width:18%" class="num-col">{{ t('tokenUsage.completionTokens') }}</th>
                                        <th style="width:12%" class="num-col">{{ t('tokenUsage.messageCount') }}</th>
                  </tr>
                </thead>
                <tbody>
          ...
          <div v-if="data.byDate && data.byDate.length > 0" class="table-section">
            ...
            <div class="table-wrap">
              <table class="data-table">
                <thead>
                  <tr>
                    <th style="width:48%">{{ t('tokenUsage.date') }}</th>
                                        <th style="width:22%" class="num-col">{{ t('tokenUsage.promptTokens') }}</th>
                                        <th style="width:18%" class="num-col">{{ t('tokenUsage.completionTokens') }}</th>
                                        <th style="width:12%" class="num-col">{{ t('tokenUsage.messageCount') }}</th>
                  </tr>
