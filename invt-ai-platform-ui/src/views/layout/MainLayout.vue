...
const roleLabel = computed(() => {
  if (role.value === 'super_admin') return t('nav.roleSuperAdmin')
  if (role.value === 'admin') return t('nav.roleAdmin')
...
/*
  ...
  invt token system (`var(--mc-danger-*)`), so dark mode picks up the
