...
//   grep -rn 'featureFlagService\.isEnabled' invt-ai-platform-server/src/main/java
const WIRED_FLAGS = new Set<string>([
  'wiki.ocr.enabled',
  'wiki.hot_cache.enabled',
  'wiki.compile.4stage.enabled',
  'wiki.compile.cache.enabled',
  'wiki.confidence.enabled',
  'wiki.graph.adamic_adar.enabled',
  'wiki.graph.boundary.enabled',
  'wiki.graph.insights.enabled',
])
