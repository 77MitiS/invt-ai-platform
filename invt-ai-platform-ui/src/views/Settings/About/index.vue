<template>
  <div class="about-page">
    <!-- Hero: Logo + Identity -->
    <section class="hero">
      <img src="/logo/invt_logo.png" alt="INVT AI Platform" class="hero-logo" />
      <div class="hero-copy">
        <h1 class="hero-title">英威腾<span class="hero-accent"> AI Studio</span></h1>
