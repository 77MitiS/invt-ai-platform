export default {
  app: {
    title: 'INVT AI Platform - AI Assistant',
  },
  common: {
    save: 'Save',
    saving: 'Saving...',
  ...
  settings: {
    ...
    model: {
      ...
      claudeCodeOauthRevokeHint: 'Sign out from the Claude Code app to revoke. Invt does not modify Claude Code\'s on-disk credentials.',
  ...
  security: {
    ...
    toolGuard: {
      ...
      exportFileName: 'invt-guard-rules-{date}.json',
  ...
  acp: {
    ...
    env: {
      ...
      hints: {
        ...
        dashscope: 'Aliyun DashScope key — same value as Invt .env DASHSCOPE_API_KEY',
  ...
  plugins: {
    ...
    emptyHint: 'Place plugin JAR files in ~/.invt/plugins/ and restart the server',
  ...
  wiki: {
    ...
    library: {
      ...
      scopePublicHint: 'Shared with the workspace',
      scopePrivateHint: 'Visible only to you',
  ...
  login: {
    ...
    heroDesc: 'Invt is not about stuffing more capability into a chat box. It is about pulling context, knowledge, execution, and memory into one reliable operating surface.',
  ...
  onboarding: {
    title: 'Welcome to INVT AI Platform',
